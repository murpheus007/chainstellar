export const works = [
   {
      ...
      description:
         'The Case for Xara’s Text-Based Financial Services and Why a Solana Integration Is Crucial',
      link: 'https://chainstellar.substack.com/when-money-talks-for-real',
      image: '/xara.jpg',
   },
   {
      id: 2,
   ...
   },
   {
      ...
      link: 'https://abdulmutalibsulaiman.substack.com/p/nigerians-are-unstable',
